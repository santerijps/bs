...
#define _BS_DEBUG_OUT BS_OUT_DIR _BS_SEP BS_DEBUG_OUT_FILE _BS_EXT
#define _BS_RELEASE_OUT BS_OUT_DIR _BS_SEP BS_RELEASE_OUT_FILE _BS_EXT
#define _BS_DEBUG_BUILD_COMMAND BS_COMPILER " " BS_SOURCE_FILES " " BS_LINKER_OPTS " " BS_DEBUG_OPTS " -o " _BS_DEBUG_OUT
#define _BS_RELEASE_BUILD_COMMAND BS_COMPILER " " BS_SOURCE_FILES " " BS_LINKER_OPTS " " BS_RELEASE_OPTS " -o " _BS_RELEASE_OUT
